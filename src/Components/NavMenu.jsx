...
export default function NavMenu({visibility}) {
  return (
    <div
      className={`flex flex-col items-center justify-center py-8 ${!visibility && "hidden"}`}
      style={{ backgroundImage: `url(${NavImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
    >
